...
if __name__ == '__main__' :
    ...
    fileparam = "8080_1000_200_0.01_10.0.pkl"   #tochange
    mbSize = 10                                #tochange
    ...
    for x in xrange(10):
        ...
        print [-i+1 for (v,i) in sorted(((v, -i) for (i, v) in enumerate(orderList) if v>0 and i!=int(testImageIdx)),reverse=True)]
